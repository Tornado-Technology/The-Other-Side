...
switch(tab) {
	...
	case MenuTabName.About:
		...
		draw_text_outline(width/3, height - height/4, "Back");
		draw_sprite(spr_left_button, 0, width/3 - 20, height - height/4);
		draw_text_outline(width - width/3 - 20, height - height/4, "OK");
		draw_sprite(spr_right_button, 0, width - width/3, height - height/4);
		break;
			
	case MenuTabName.Control:
		draw_set_halign(fa_center);
		draw_text_outline(width/2, height/6, "Control");
		draw_text_outline(width/3, height/2 - 35, "Move");
		draw_sprite(spr_w_button, 0, width/3, height/2 - 5);
		draw_sprite(spr_s_button, 0, width/3, height/2 + 16);
		draw_sprite(spr_d_button, 0, width/3 - 16, height/2);
		draw_sprite(spr_a_button, 0, width/3 + 16, height/2);
		draw_text_outline(width - width/3, height/2 - 35, "Attack");
		draw_sprite(spr_up_button,   0, width - width / 3,      height / 2 - 5);
		draw_sprite(spr_down_button, 0, width - width / 3,      height / 2 + 16);
